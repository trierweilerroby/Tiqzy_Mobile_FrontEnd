...
@Composable
fun PreviewAppleAndGoogle() {
    AppleAndGoogle(
        onAppleLoginClick = { /* Mock action for Apple login */ },
        onGoogleLoginClick = { /* Mock action for Google login */ },
        onSignUpClick = { /* Mock action for sign up */ }
    )
}
